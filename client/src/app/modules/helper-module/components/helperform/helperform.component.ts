...
export class HelperformComponent implements OnInit {
  ...
  typeOfServiceOptions: Array<{ label: string; value: string }>;
  organizationNameOptions: Array<{ label: string; value: string }>;
  ...
  constructor(
    ...
    this.vehicleTypeOptions = ['None', 'Auto', 'Car', 'Bike'];
    this.countryCallingCodeOptions = [
      { label: '+1', value: 1 },
      { label: '+20', value: 20 },
      { label: '+27', value: 27 },
      { label: '+210', value: 210 },
